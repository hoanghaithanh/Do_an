...
```
python neuMF_pure_tf_high_API.py --path ../../Data/exp_ml-20m_tmp/ --dataset exp_ml-20m_tmp --epochs 20 --batch_size 256 --num_factors 8 --layers [64,32,16,8] --reg_mf 0 --num_train_neg 4 --num_test_neg 5 --lr 0.001 --learner adam
```
